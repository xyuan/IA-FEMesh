...
vtkCxxRevisionMacro(vtkKWMimxDefineNodeSetGroup, "$Revision: 1.15 $");
...
{
  //if (this->SelectionState != mode )
  //{
  //  return;
  //}
  //std::cout << "Disable Node Selection" << std::endl;  
  this->SelectionState = -1;
	if(this->SelectPointsWidget)
	{
		if(this->SelectPointsWidget->GetEnabled())
