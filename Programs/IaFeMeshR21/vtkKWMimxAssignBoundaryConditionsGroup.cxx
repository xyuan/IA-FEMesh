...
vtkCxxRevisionMacro(vtkKWMimxAssignBoundaryConditionsGroup, "$Revision: 1.58 $");
...
vtkKWMimxAssignBoundaryConditionsGroup::vtkKWMimxAssignBoundaryConditionsGroup()
{
  ...
  //BoundaryConditionActor->SetRenderer( this->GetMimxMainWindow()->GetRenderWidget()->GetRenderer() );
  //
  //this->ForceGlyphActorX = NULL;
  //this->ForceGlyphActorY = NULL;
  //this->ForceGlyphActorZ = NULL;
  //this->ForceGlyphX = NULL;
  //this->ForceGlyphY = NULL;
  //this->ForceGlyphZ = NULL;
  ////
  //this->DisplacementGlyphActorX = NULL;
  //this->DisplacementGlyphActorY = NULL;
  //this->DisplacementGlyphActorZ = NULL;
  //this->DisplacementGlyphX = NULL;
  //this->DisplacementGlyphY = NULL;
  //this->DisplacementGlyphZ = NULL;
  ////
  //this->RotationGlyphActorX = NULL;
  //this->RotationGlyphActorY = NULL;
  //this->RotationGlyphActorZ = NULL;
  //this->RotationGlyphX = NULL;
  //this->RotationGlyphY = NULL;
  //this->RotationGlyphZ = NULL;
  ////
  //this->MomentGlyphActorX = NULL;
  //this->MomentGlyphActorY = NULL;
  //this->MomentGlyphActorZ = NULL;
  //this->MomentGlyphX = NULL;
  //this->MomentGlyphY = NULL;
  //this->MomentGlyphZ = NULL;
...
vtkKWMimxAssignBoundaryConditionsGroup::~vtkKWMimxAssignBoundaryConditionsGroup()
{
  ...
  //
  //if(this->ForceGlyphActorX)
	 // this->ForceGlyphActorX->Delete();
  //if(this->ForceGlyphActorY)
	 // this->ForceGlyphActorY->Delete();
  //if(this->ForceGlyphActorZ)
	 // this->ForceGlyphActorZ->Delete();
  //if(this->ForceGlyphX)
  // this->ForceGlyphX->Delete();
  //if(this->ForceGlyphY)
  // this->ForceGlyphY->Delete();
  //if(this->ForceGlyphZ)
  // this->ForceGlyphZ->Delete();
  ////
  //if(this->DisplacementGlyphActorX)
	 // this->DisplacementGlyphActorX->Delete();
  //if(this->DisplacementGlyphActorY)
	 // this->DisplacementGlyphActorY->Delete();
  //if(this->DisplacementGlyphActorZ)
	 // this->DisplacementGlyphActorZ->Delete();
  //if(this->DisplacementGlyphX)
	 // this->DisplacementGlyphX->Delete();
  //if(this->DisplacementGlyphY)
	 // this->DisplacementGlyphY->Delete();
  //if(this->DisplacementGlyphZ)
	 // this->DisplacementGlyphZ->Delete();
  ////
  //if(this->RotationGlyphActorX)
	 // this->RotationGlyphActorX->Delete();
  //if(this->RotationGlyphActorY)
	 // this->RotationGlyphActorY->Delete();
  //if(this->RotationGlyphActorZ)
	 // this->RotationGlyphActorZ->Delete();
  //if(this->RotationGlyphX)
	 // this->RotationGlyphX->Delete();
  //if(this->RotationGlyphY)
	 // this->RotationGlyphY->Delete();
  //if(this->RotationGlyphZ)
	 // this->ForceGlyphZ->Delete();
  ////
  //if(this->MomentGlyphActorX)
	 // this->MomentGlyphActorX->Delete();
  //if(this->MomentGlyphActorY)
	 // this->MomentGlyphActorY->Delete();
  //if(this->MomentGlyphActorZ)
	 // this->MomentGlyphActorZ->Delete();
  //if(this->MomentGlyphX)
	 // this->MomentGlyphX->Delete();
  //if(this->MomentGlyphY)
	 // this->MomentGlyphY->Delete();
  //if(this->MomentGlyphZ)
	 // this->ForceGlyphZ->Delete();
  //
...
void vtkKWMimxAssignBoundaryConditionsGroup::CreateWidget()
{
 ...
 //this->DefineNodeSetPushButton->SetText("Node Set Definitions");
 //this->DefineNodeSetPushButton->SetWidth( 25 );
...
/*
 ...
 this->StepNumberComboBox->SetParent(this->StepFrame);
...
*/
 ...
 //this->AddStepPushButton->SetText("Add Step");
 ...
 //this->DeleteStepPushButton->SetText("Delete Step");
...
//  this->OpacityThumbwheel->SetEnabled(0);
  ...
  //this->DefineControlPushButton->SetText("Step Control Definitions");
  //this->DefineControlPushButton->SetBorderWidth( 2 );
  ...
  //this->DefineNodeSetPushButton->SetStateToDisabled();

  //this->BoundaryConditionTypeComboBox->SetStateToNormal();
  //this->NodeSetComboBox->SetStateToDisabled();
  //this->DirectionXEntry->SetStateToDisabled();
  //this->DirectionYEntry->SetStateToDisabled();
  //this->DirectionZEntry->SetStateToDisabled();
...
int vtkKWMimxAssignBoundaryConditionsGroup::AssignBoundaryConditionsApplyCallback()
{
  ...
  if (!strcmp(entryx,"") && !strcmp(entryy,"") && !strcmp(entryz,""))
  {
	  ...
	  /***VAM ***/
	  //ADD New Actor Equivalent
	  this->DeleteBoundaryConditionActor( std::string bcName );
	  //this->DeleteBoundaryConditionActor(NodeSetname, boundaryconditiontype);
  ...
  char stepnum[16];
  sprintf(stepnum, "%d", activePage);  /*this->StepNumberComboBox->GetWidget()->GetValue()*/
  char boundname[256];
...
void vtkKWMimxAssignBoundaryConditionsGroup::UpdateObjectLists()
{
	...
	//this->CreateBoundaryConditionActors();
}
//--------------------------------------------------------------------------------
...
//	this->StepNumberChangedCallback( numentries );
	//if(this->DefineNodeSetDialog)
	//	this->DefineNodeSetDialog->ResetState();
	...
	this->BoundaryConditionActor->SetGlyphSize( this->GlyphSize );
	this->GetMimxMainWindow()->GetRenderWidget()->Render();
	...
	//this->BoundaryConditionTypeComboBox->SetStateToNormal();
  //this->NodeSetComboBox->SetStateToNormal();
  //this->DirectionXEntry->SetStateToNormal();
  //this->DirectionYEntry->SetStateToNormal();
  //this->DirectionZEntry->SetStateToNormal();
...
//	}
	//if(this->GetValue())
	//{
	//	if(this->ViewBoundaryConditionsButton->GetWidget()->GetSelectedState())
	//	{
	//		this->ViewBoundaryConditionsButton->GetWidget()->SetSelectedState(0);
	//	}
	//	this->ViewBoundaryConditionsButton->GetWidget()->SetSelectedState(1);
	//}
	//else
	//{
	//	this->ViewBoundaryConditionsButton->GetWidget()->SetSelectedState(0);
...
void vtkKWMimxAssignBoundaryConditionsGroup::AddStepNumberCallback()
{
  ...
  else
  {
	...
	//std::cout << "Start Page " << this->startNotebookPage << std::endl;
	//std::cout << "End Page " << this->endNotebookPage << std::endl;
...
void vtkKWMimxAssignBoundaryConditionsGroup::StepNumberChangedCallback( const char *StepNum )
{
	...
	//if(!strcmp(this->stepNumPrevious, this->StepNumberComboBox->GetWidget()->GetValue()))
	//	return;
	//if(StepNum)	
	//{
	//	vtkKWComboBox *combobox = this->ObjectListComboBox->GetWidget();
	...
	//	
	//	if (strarray == NULL)
	//	  this->NodeSetComboBox->GetWidget()->SetValue("");
	//	else
	//	  this->NodeSetComboBox->GetWidget()->SetValue(strarray->GetValue(numarrrays-1));
...
//	this->NodeSetChangedCallback(this->NodeSetComboBox->GetWidget()->GetValue());
}
//-----------------------------------------------------------------------------------------
                                                          ...
                                                          void *calldata)
{
  ...
  switch (event)
    ...
    case vtkKWEvent::NotebookRaisePageEvent:
      ...
      {
        //std::cout << "<<<<<<<<<<<<<<<<<<" << std::endl;
        //std::cout << "Current start : " << this->startNotebookPage << std::endl;
  ...
  {    
    this->StepNotebook->HideAllPages();
    this->StepNotebook->ShowPage("<");
    //std::cout << "Process Start Index : " << this->startNotebookPage << std::endl;
    //std::cout << "Process End Index : " << this->endNotebookPage << std::endl;
    for (int i=this->startNotebookPage;i<this->endNotebookPage;i++)
    {
      char stepNumberStr[16];
      sprintf(stepNumberStr, "STEP %d", i+1);
...
void vtkKWMimxAssignBoundaryConditionsGroup::ShowBoundaryConditionRepresentation(int ConditionNum)
{
	...
	this->MultiColumnList->GetWidget()->GetCellWindowAsCheckButton(ConditionNum, 0)->SetSelectedState(1);
	this->GetMimxMainWindow()->GetRenderWidget()->Render();
#endif
...
void vtkKWMimxAssignBoundaryConditionsGroup::StepControlCallback()
{
  ...
  if (!this->StepParameterLabel)
  {
    this->StepParameterLabel = vtkKWLabel::New();
    this->StepParameterLabel->SetParent( this->StepParameterFrame->GetFrame() );
    this->StepParameterLabel->Create();
    this->StepParameterLabel->SetText("*STEP");
    this->GetApplication()->Script(
      "pack %s -side top -anchor nw -padx 2 -pady 2", 
      this->StepParameterLabel->GetWidgetName());
  }
  */
  if (!this->StepIncrementEntry)
  {
...
// populate the node set list	
  ...
  //this->GenerateStepParameters(this->GetNotebookStep());
...
{
	if(Entry == "")	return;
	if(this->NodeSetMenu->GetWidget()->GetValue() == "")
	{
		return ;
	}
	const char *nodesetname = this->NodeSetMenu->GetWidget()->GetValue();
