...
vtkCxxRevisionMacro(vtkKWMimxApplication, "$Revision: 1.18.4.1 $");
...
vtkKWMimxApplication::vtkKWMimxApplication()
{
  ...
  this->TextColor[0] = this->TextColor[1] = this->TextColor[2] = 1.0;
	...
	std::string tmpDate =  "IA-FEMesh-Autosave-" + vtksys::SystemTools::GetCurrentDateTime("%Y%m%d-%H%M");
