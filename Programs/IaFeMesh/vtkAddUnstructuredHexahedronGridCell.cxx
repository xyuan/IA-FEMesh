/*=========================================================================
  ...
  Module:    $RCSfile: vtkAddUnstructuredHexahedronGridCell.cxx,v $
...
vtkCxxRevisionMacro(vtkAddUnstructuredHexahedronGridCell, "$Revision: 1.1 $");
vtkStandardNewMacro(vtkAddUnstructuredHexahedronGridCell);

// Description:

vtkAddUnstructuredHexahedronGridCell::vtkAddUnstructuredHexahedronGridCell()
{
	this->IdList = NULL;
...
int vtkAddUnstructuredHexahedronGridCell::RequestData(
...
void vtkAddUnstructuredHexahedronGridCell::PrintSelf(ostream& os, vtkIndent indent)
{
