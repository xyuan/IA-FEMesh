...
int main( int argc, char *argv[] )
{
  ...
  const InternalPixelType  timeThreshold = atof( argv[9] );
  ...
  writer1->SetFileName("FastMarchingFilterOutput1-Smooth.hdr");
  ...
  writer2->SetFileName("FastMarchingFilterOutput2-Gradient.hdr");
  ...
  writer3->SetFileName("FastMarchingFilterOutput3-Sigmoid.hdr");
  ...
  writer4->SetFileName("FastMarchingFilterOutput4-Fast.hdr");
  ...
  mapWriter->SetFileName("FastMarchingFilterOutput4-Int-Fast.hdr");
  mapWriter->Update();

  InternalWriterType::Pointer speedWriter = InternalWriterType::New();
  speedWriter->SetInput( sigmoid->GetOutput() );
  speedWriter->SetFileName("FastMarchingFilterOutput3-Int-Sigmoid.hdr");
  speedWriter->Update();

  InternalWriterType::Pointer gradientWriter = InternalWriterType::New();
  gradientWriter->SetInput( gradientMagnitude->GetOutput() );
  gradientWriter->SetFileName("FastMarchingFilterOutput2-Int-Gradient.hdr");
