/*=========================================================================
  ...
  Module:    $RCSfile: DeformImageFeRegistration.cxx,v $
  Language:  C++
  Date:      $Date: 2006/12/11 12:41:13 $
...
int main(int argc, char *argv[])
{
  ...
  FileImageType::Pointer movingImage = movingfilter->GetOutput();
  ...
  FileImageType::Pointer fixedImage = fixedfilter->GetOutput();
