...
typename ImageType::Pointer Iadd(const typename ImageType::Pointer &input1,typename ImageType::Pointer &input2 )
{
...
template <class ImageType>
typename ImageType::Pointer Isub(const typename ImageType::Pointer &input1,const typename ImageType::Pointer &input2 )
{
...
template <class ImageType>
typename ImageType::Pointer Imul(const typename ImageType::Pointer &input1,const typename ImageType::Pointer &input2 )
{
...
template <class ImageType>
typename ImageType::Pointer Idiv(const typename ImageType::Pointer &input1,const typename ImageType::Pointer &input2 )
{
...
{
  typename itk::ImageRegionIterator< ImageType > in1(input1 , input1->GetLargestPossibleRegion());
