...
int main( int argc, char * argv[] )
{
  ...
  {
    vtkMimxRebinMaterialProperty *rebinMeshMaterialProperties = 
  ...
  /* Write of the Mesh in Abaqus file format */
  ...
  /* Write of the Mesh in VTK file format */
  ...
  /* Write of the Mesh in VTK file format - Surface nodes only Temporary Slicer3 Hack */
